...
The results can then be plotted as desired using `ggplot2` or another visualization package. Our results could be interpreted as showing a cluster of static genes (cluster 1) and a cluster of dynamic genes (cluster 2).
