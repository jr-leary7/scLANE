...
To install the current version of `scLANE` from BioConductor, run the following:

```{r install-scLANE-bioc, eval=FALSE}
...
Alternatively, you can install the development version of `scLANE` using:

```{r install-scLANE-git, eval=FALSE}
