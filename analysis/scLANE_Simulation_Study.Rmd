...
And now let's run `scaffold`. We want to generate a UMI-based 10X dataset with 3,000 cells, and 2,400 dynamic genes.
...
gene_stats <- testDynamic(expr.mat = sim_counts[, 1:5], 
                          pt = pt_df, 
                          parallel.exec = TRUE, 
                          n.cores = 4, 
