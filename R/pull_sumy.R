pull.null.sumy <- function(mod.obj, is.gee, is.glmm) {
  ...
  if (inherits(mod.obj, "try-error")) {return(list(null_sumy_df=NA, null_pred_df=NA, null_ll=NA_real_, null_dev=NA_real_))}
 ...
 return(list(null_sumy_df=null_sumy_df, null_pred_df=null_pred_df, null_ll=null_ll, null_dev=null_dev))
...
pull.marge.sumy <- function(mod.obj, is.gee, is.glmm) {

  if (inherits(mod.obj, "try-error")) {

    return(list(marge_pred_df=NA, marge_sumy_df=NA, 
                ll_marge=NA_real_, marge_fit_notes=NA_character_))
  }
...
marge_dev <- ifelse((is.gee || is.glmm), NA_real_, stats::deviance(mod.obj$final_mod))
 ...
 return(list(marge_pred_df=marge_pred_df, marge_sumy_df=marge_sumy_df, 
             ll_marge=ll_marge, marge_dev=marge_dev, marge_fit_notes=marge_fit_notes))
